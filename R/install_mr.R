...
install_mr <- function(){
  ...
  packages <- c("usethis", "devtools", "remotes","data.table", "do", "eoffice", "epigraphdb", "metafor", "psych","ggplot2","gdata","textshaping","forestploter","progress", "future", "furrr", "hms", "MendelianRandomization")
